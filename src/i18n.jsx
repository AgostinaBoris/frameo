...
const translations = {
  en: {
    ...
    'profile.saveError': "Couldn't save. Try again.",
    'profile.loginToCustomize': 'Log in to customize your profile.',
    'profile.guestName': 'Guest',
    'profile.save': 'Save',
    'profile.cancel': 'Cancel',
    'profile.photoTooLarge': 'Image must be under 5MB.',
  ...
  es: {
    ...
    'profile.saveError': 'No se pudo guardar. Intentá de nuevo.',
    'profile.loginToCustomize': 'Iniciá sesión para personalizar tu perfil.',
    'profile.guestName': 'Invitado',
    'profile.save': 'Guardar',
    'profile.cancel': 'Cancelar',
    'profile.photoTooLarge': 'La imagen debe pesar menos de 5MB.',
    'profile.photoInvalidType': 'Elegí un archivo de imagen.',
